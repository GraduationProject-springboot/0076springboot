...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV16ia6epENY?p=77)
...
1. 先进性：采用目前国际上最先进的开发技术，使用JSP开发技术，MySQL 作为网站后台数据库。采用这些技术降低了以后的系统运营成本，提高了系统的稳定性和易维护性。
...
|shangchedidian|varchar(200)|是|NULL|上车地点|
|mudedi|varchar(200)|是|NULL|目的地|
|chufashijian|varchar(200)|是|NULL|出发时间|
|jiage|varchar(200)|是|NULL|价格|
|renshu|varchar(200)|否||人数|
|shenfenzhenghao|varchar(200)|否||身份证号|
...
|yonghuming|varchar(200)|是|NULL|用户名|
|xingming|varchar(200)|是|NULL|姓名|
|fankuileixing|varchar(200)|否||反馈类型|
|xiangxixinxi|longtext|否||详细信息|
...
|huanpiaomudedi|varchar(200)|否||换票目的地|
|sfsh|varchar(200)|是|否|是否审核|
|shhf|longtext|是|NULL|审核回复|
表4.4 留言板
...
|id (主键)|bigint(20)|否||主键|
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|chepiaomingcheng|varchar(200)|是|NULL|车票名称|
|shangchedidian|varchar(200)|是|NULL|上车地点|
|mudedi|varchar(200)|是|NULL|目的地|
|chufashijian|datetime|是|NULL|出发时间|
|yujidaodashijian|datetime|是|NULL|预计到达时间|
|tujingdi|varchar(200)|是|NULL|途径地|
|jiage|float|是|NULL|价格|
|renshu|int(11)|是|NULL|人数|
...
|shenfenzhenghao|varchar(200)|是|NULL|身份证号|
|shoujihao|varchar(200)|是|NULL|手机号|
|tuipiaoyuanyin|longtext|是|NULL|退票原因|
|sfsh|varchar(200)|是|否|是否审核|
|shhf|longtext|是|NULL|审核回复|
表4.8 管理员表
